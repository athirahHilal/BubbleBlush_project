...
const Makeup = ({ navigation }) => {
  ...
  const specialOffers = [
    ...
    { id: 2, image: require('../assets/makeup/b.jpg') },
    { id: 3, image: require('../assets/makeup/c.jpg') },
  ];

  const fetchHotSaleMakeupProducts = async () => {
    setIsHotSaleLoading(true);
    setHotSaleError(null);
    try {
      const data = await fetchProductByTypeCategory('hotSale', 'makeup');
  ...
  const fetchAdditionalMakeupProducts = async () => {
    setIsLoading(true);
    setError(null);
    try {
      const data = await fetchProductByCategory('makeup');
  ...
  useEffect(() => {
    const initializeFetches = async () => {
      ...
      await fetchHotSaleMakeupProducts();
      await fetchAdditionalMakeupProducts();
    };
        ...
        <View style={styles.whiteContentContainer}>
          ...
          {isHotSaleLoading ? (
            ...
            <View style={styles.errorContainer}>
              ...
              <TouchableOpacity onPress={fetchHotSaleMakeupProducts} style={styles.retryButton}>
