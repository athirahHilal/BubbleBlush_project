...
const Fragrance = ({ navigation }) => {
  ...
  const fetchHotSaleFragranceProducts = async () => {
    ...
    try {
      const data = await fetchProductByTypeCategory('hotSale', 'fragrance');
  ...
  const fetchAdditionalFragranceProducts = async () => {
    setIsLoading(true);
    setError(null);
    try {
      const data = await fetchProductByCategory('fragrance');
  ...
  useEffect(() => {
    const initializeFetches = async () => {
      ...
      await fetchHotSaleFragranceProducts();
      await fetchAdditionalFragranceProducts();
    };
        ...
        <View style={styles.whiteContentContainer}>
          ...
          {isHotSaleLoading ? (
            ...
            <View style={styles.errorContainer}>
              ...
              <TouchableOpacity onPress={fetchHotSaleFragranceProducts} style={styles.retryButton}>
