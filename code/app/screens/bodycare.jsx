...
const Bodycare = ({ navigation }) => {
  ...
  const specialOffers = [
    { id: 1, image: require('../assets/bodycare/a.jpg') },
    { id: 2, image: require('../assets/bodycare/b.jpg') },
    { id: 3, image: require('../assets/bodycare/c.jpg') },
  ];

  const fetchHotSaleBodycareProducts = async () => {
    setIsHotSaleLoading(true);
    setHotSaleError(null);
    try {
      const data = await fetchProductByTypeCategory('hotSale', 'bodycare');
  ...
  const fetchAdditionalBodycareProducts = async () => {
    setIsLoading(true);
    setError(null);
    try {
      const data = await fetchProductByCategory('bodycare');
  ...
  useEffect(() => {
    const initializeFetches = async () => {
      ...
      await fetchHotSaleBodycareProducts();
      await fetchAdditionalBodycareProducts();
    };
        ...
        <View style={styles.whiteContentContainer}>
          ...
          {isHotSaleLoading ? (
            ...
            <View style={styles.errorContainer}>
              ...
              <TouchableOpacity onPress={fetchHotSaleBodycareProducts} style={styles.retryButton}>
