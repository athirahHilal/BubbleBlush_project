...
const Skincare = ({ navigation }) => {
  ...
  const specialOffers = [
    { id: 1, image: require('../assets/skincare/a.jpg') },
    { id: 2, image: require('../assets/skincare/b.jpg') },
    { id: 3, image: require('../assets/skincare/c.jpg') },
  ];

  const fetchHotSaleSkincareProducts = async () => {
    setIsHotSaleLoading(true);
    setHotSaleError(null);
    try {
      const data = await fetchProductByTypeCategory('hotSale', 'skincare');
  ...
  const fetchAdditionalSkincareProducts = async () => {
    setIsLoading(true);
    setError(null);
    try {
      const data = await fetchProductByCategory('skincare');
  ...
  useEffect(() => {
    const initializeFetches = async () => {
      ...
      await fetchHotSaleSkincareProducts();
      await fetchAdditionalSkincareProducts();
    };
        ...
        <View style={styles.videoFrameContainer}>
          <View style={styles.videoInnerContainer}>
            {videoError ? (
              ...
              <Video
                source={require('../assets/skincare/skincare.mp4')}
        ...
        <View style={styles.whiteContentContainer}>
          ...
          {isHotSaleLoading ? (
            ...
            <View style={styles.errorContainer}>
              ...
              <TouchableOpacity onPress={fetchHotSaleSkincareProducts} style={styles.retryButton}>
